      ...
      <section className="section-padding bg-gray-50 min-h-[60vh] flex flex-col items-center justify-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-lg text-gray-700 mb-8 max-w-xl text-center">
            Pay easily for your transportation and logistics services in Mumbai and Maharashtra.<br />
            <span className="font-semibold">We support UPI-app payments and all major credit/debit cards for your convenience!</span>
          </p>
